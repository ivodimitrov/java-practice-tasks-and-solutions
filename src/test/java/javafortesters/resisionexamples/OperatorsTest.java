package javafortesters.resisionexamples;
...
public class OperatorsTest {
    ...
    public void incrementDecrementOperatorsExplored() {
        int num = 10;
        /*
        • Putting ++ or -- before the variable means that you want to amend it before using it.
        (prefix)
        • Putting ++ or -- after the variable means that you want to use it and then amend it.
        (postfix)
         */
        assertEquals(11, ++num);
        assertEquals(10, --num);
